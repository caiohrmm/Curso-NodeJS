...
app.post("/users/insert", async (req, res) => {
  ...
  const data = { name, occupation, isworking: isWorking };
...
// Fazendo o insert de dados relacionados
...
// Fazendo delete de dados selecionados
...
// Excluindo com sequelize
app.post("/users/delete/:id", async (req, res) => {
  const id = req.params.id;

  // Aqui, como somente irei excluir, nao preciso de variaveis, somente do comando
...
app.get("/users/edit/:id", async (req, res) => {
  ...
  try {
    ...
    // Para pegar dados relacionados juntamente com os dados do usuario, inves do raw
    // Usarei o include, que facilitará meu uso
    // Depois, na hora de passar os dados farei um get plain.
...
app.post("/users/editing", async (req, res) => {
  ...
  const userData = { id, name, occupation, isworking: isWorking };
...
dbconnection
  /* Parametro force -> Esse cara excluir a tabela e todos os dados e a recria novamente */
  .sync(/*{force:true}*/)
  .then(
    app.listen(port, () =>
      console.log(
